#!/bin/bash
# Launch a Kraft unikernel with QEMU runtime, metadata service access, and volume mounting
#
# This script sets up networking so the unikernel can reach:
#   - Internet (via NAT)
#   - Metadata service at 169.254.169.254
#
# QEMU supports virtio-fs/9pfs for live directory mounting (unlike Firecracker).
#
# Prerequisites:
...
# Volume mount: host_path:guest_path
VOLUME_MOUNT="./data:/mnt/data"
...
echo ""
echo "========================================"
echo "Launching Kraft unikernel '$VM_ID' (QEMU)"
echo "========================================"
echo ""
echo "Network:"
